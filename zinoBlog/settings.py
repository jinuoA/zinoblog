...
WSGI_APPLICATION = 'zinoBlog.wsgi.application'
...
EMAIL_SUBJECT_PREFIX = u'zino'       # 为邮件Subject-line前缀,默认是'[django]'
...
# 网站标题等内容配置
WEBSITE_TITLE = u'Zino'
WEBSITE_WELCOME = u'欢迎来到Zino'
