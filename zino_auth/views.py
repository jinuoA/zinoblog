...
from zino_auth.forms import ZinoUserCreationForm, VmaigPasswordRestForm
from zino_auth.models import ZinoUser
from zino_system.models import Notification
import time
import datetime
...
class UserControl(View):
    ...
    def register(self, request):
        ...
        form = ZinoUserCreationForm(request.POST)
    ...
    def resetpassword(self, request):
        ...
        try:
            ...
            user = ZinoUser._default_manager.get(pk=uid)
        except (TypeError, ValueError, OverflowError, ZinoUser.DoesNotExist):
            user = None
